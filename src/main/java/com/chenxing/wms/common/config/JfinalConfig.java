package com.chenxing.wms.common.config;

import cn.hutool.core.util.ClassLoaderUtil;
import com.alibaba.druid.wall.WallFilter;
import com.jfinal.aop.Aop;
import com.chenxing.wms.common.config.cache.CaffeineCache;
import com.chenxing.wms.common.config.druid.DruidConfig;
import com.chenxing.wms.common.config.json.ErpJsonFactory;
import com.chenxing.wms.common.config.paragetter.BasePageRequest;
import com.chenxing.wms.common.config.paragetter.MapParaGetter;
import com.chenxing.wms.common.config.paragetter.PageParaGetter;
import com.chenxing.wms.common.config.redis.RedisPlugin;
import com.chenxing.wms.common.config.render.ErpRenderFactory;
import com.chenxing.wms.common.constant.BaseConstant;
import com.chenxing.wms.common.interceptor.AuthInterceptor;
import com.chenxing.wms.common.interceptor.ErpInterceptor;
import com.chenxing.wms.erp._MappingKit;
import com.chenxing.wms.erp.admin.common.AdminRouter;
import com.chenxing.wms.erp.admin.service.AdminFieldService;
import com.chenxing.wms.erp.bi.common.BiRouter;
import com.chenxing.wms.erp.crm.common.CrmDirective;
import com.chenxing.wms.erp.crm.common.CrmRouter;
import com.chenxing.wms.erp.oa.common.OaRouter;
import com.chenxing.wms.erp.work.common.WorkRouter;
...
import com.chenxing.wms.erp.work.service.WorkService;
...
public class JfinalConfig extends JFinalConfig {
    ...
    public final static Prop prop = PropKit.use("config/wms-config.txt");
