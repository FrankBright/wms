 ...
 * Redis的sentinel实现
 */
public class JedisSentinelImpl implements Redis {
    private JedisSentinelPool jedisSentinelPool;
    private ISerializer serializer;
    private IKeyNamingPolicy keyNamingPolicy;

    JedisSentinelImpl(JedisSentinelPool jedisSentinelPool, ISerializer serializer, IKeyNamingPolicy keyNamingPolicy) {
    ...
    public String hmset(Object key, Map<Object, Object> hash) {
        ...
        try {
            ...
            hash.forEach((k, v) -> para.put(fieldToBytes(k), valueToBytes(v)));
    ...
    public Map hgetAll(Object key) {
        ...
        try {
            ...
            data.forEach((k, v) -> result.put(fieldFromBytes(k), valueFromBytes(v)));
            return result;
        } finally {
            close(jedis);
        }
